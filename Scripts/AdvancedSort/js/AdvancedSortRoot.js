...
$.fn.AdvancedSort = function (options) {
    ...
    if ($(this)) {
        ...
        $(`#${defaults.gridName}`).AdvancedSortGridExtention().init(defaults.excludedColumn);
    }
};
...
$.fn.AdvancedSortGridExtention = function () {
    ...
    function init(excludedColumn) {
        if (excludedColumn == null || excludedColumn == undefined) {
            excludedColumn = [];
        }
        ...
        kendo.syncReady(function () {
            require(['AdvancedSort/AdvancedSortMain'], function (main) {
                new main.AdvancedSort(gridName, excludedColumn);
            });
        });
    }
